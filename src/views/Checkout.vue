                  ...
                  <div class="panel-body">
                    <div class="row">
                      ...
                      <div class="col-md-6 col-sm-6 guest-login">
                        ...
                        <form class="register-form" role="form">
                          <div class="radio radio-checkout-unicase">
                            <input
                              ...
                              checked
                            />
                            <label class="radio-button guest-check" for="guest"
                            ...
                            <input
                              ...
                              value="register"
                            />
                            <label class="radio-button" for="register"
                              >Register</label
                            >
                          </div>
                        </form>
                        ...
                        <h4 class="checkout-subtitle outer-top-vs">
                        ...
                        <button
                          ...
                          class="
                            ...
                            checkout-page-button checkout-continue
                          "
                        >
                          Continue
                        </button>
