          ...
          <div class="col-md-12 terms-conditions">
            ...
            <div class="">
              ...
              <p>
                ...
                replace these Terms and Conditions by posting the updated terms
                on the Site. Your continued use of the Site after any such
              ...
              <p>
                ...
                us filling this
                <a href="#" class="contact-form">contact form</a>
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="col-xs-12 col-sm-6 col-md-3">
            ...
            <div class="module-body">
              <ul class="list-unstyled">
                ...
                <li>
                  <a title="Information" href="#">Customer Service</a>
                </li>
                <li><a title="Addresses" href="#">Company</a></li>
                <li>
                  <a title="Addresses" href="#">Investor Relations</a>
                </li>
                <li class="last">
